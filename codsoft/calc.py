...
class Calculator:
    def __init__(self):
        ...
        # Correct spelling: 'weight' instead of 'weigth'
        self.buttons_frame.rowconfigure(0, weight=1)
        for x in range(1, 5):
            self.buttons_frame.rowconfigure(x, weight=1)  # Correct spelling here
            self.buttons_frame.columnconfigure(x, weight=1)  # Correct spelling here
